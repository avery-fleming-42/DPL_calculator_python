...
def A11B_outputs(stored_values, *_):
    """
    ...
    Inputs:
        stored_values: dict with keys:
            ...
            entry_3: Converged Flow Rate (Qc, cfm)
    ...
    try:
        ...
        # ==========================
        #   BRANCH LOSS COEFFICIENT (A11B)
        # ==========================
        branch_data = get_case_table("A11B")
        branch_data = branch_data[branch_data["PATH"] == "branch"].copy()

        if branch_data.empty:
            return {"Error": "No branch data found for A11B."}
