...
def A11I_outputs(stored_values, *_):
    """
    Calculate outputs for A11I case.
    ...
    try:
        ...
        # ==========================
        #   BRANCH LOSS COEFFICIENT (A11I)
        # ==========================
        try:
            branch_data = get_case_table("A11I")
            branch_data = branch_data[branch_data["PATH"] == "branch"].copy()
        except KeyError:
            return {"Error": "A11I branch data not found."}

        if branch_data.empty:
            return {"Error": "No branch data found for A11I."}
...
A11I_outputs.output_type = "branch_main"
