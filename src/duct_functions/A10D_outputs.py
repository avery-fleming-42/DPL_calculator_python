...
def A10D_outputs(stored_values, *_):
    """
    Calculates the outputs for case A10D (converging junctions) for both branch and main.
    ...
    try:
        ...
        area_main = (entry_1 * entry_2) / 144.0   # Ac [ft²]
        ...
        # Load case-specific table once
        df = get_case_table("A10D")
        ...
        # For now we follow the A10C pattern and pick C based on Qb/Qs only
...
A10D_outputs.output_type = "branch_main"
print("[DEBUG] A10D_outputs module loaded, output_type =", A10D_outputs.output_type)
